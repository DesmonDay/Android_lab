...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int[] shopItemPic = {
                R.mipmap.enchartedforest, R.mipmap.arla, R.mipmap.devondale, R.mipmap.kindle, R.mipmap.waitrose,
                R.mipmap.mcvitie, R.mipmap.ferrero, R.mipmap.maltesers, R.mipmap.lindt, R.mipmap.borggreve
        };

        Random random = new Random();
        int i = random.nextInt(mDatas.size());
        //应用一启动就产生通知
        intentBroadcast = new Intent("randomRecommendation");
        mBundle = new Bundle();
        mBundle.putString("name", commodity_name[i]);
        mBundle.putString("price",commodity_price[i]);
        mBundle.putString("Info",commodity_Info[i]);
